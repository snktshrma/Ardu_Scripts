...
# the radius of the circle
    ...
    def obs(self, msg):
        self.data[0]= msg.ranges[360]
        self.data[1]= msg.ranges[540]
        self.data[2]= msg.ranges[180]
        self.data[3]= msg.ranges[1]
    ...
    def updateSp(self):
        ...
        try:
            if self.data[0] > 40:
                ...
                self.sp.position.y = 200
                self.pose[0] = self.local_pos.x
                self.pose[1] = self.local_pos.y
            elif 1 <= self.data[0] <= 40:
                self.sp.position.z = self.sp.position.z + 1
                self.sp.position.y = self.pose[1]

            elif 1 <= self.data[1] <= 40:
                self.sp.position.x = self.pose[0] + 10
                self.sp.position.z = self.sp.position.z + 1

            elif 1 <= self.data[2] <= 40:
                self.sp.position.x = self.pose[0] - 10
                self.sp.position.z = self.sp.position.z + 1
